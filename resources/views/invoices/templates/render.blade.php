@php
    ...
    // The billed lines of the invoice, extracted to a service so the
    // QuickBooks export bills exactly what this document prints rather than
    // deriving a second, drifting breakdown of its own.
    //
    // A summary has no lines of its own -- it is a cover sheet, and the
    // summary_items table below is its breakdown.
    $lineItems = $isSummary ? [] : \App\Services\InvoiceLineItems::build($values);
