            ...
            <section class="rounded-3xl border border-slate-200 bg-white/90 m-6 p-6 shadow-sm">
                <form method="GET" action="{{ route('my.invoices.index') }}" class="grid gap-4 md:grid-cols-6">
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200">
                    ...
                    <div>
                        ...
                        <input type="date" name="from" value="{{ $filters['from'] ?? '' }}" class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200">
                    </div>
                    <div>
