<section class="rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-sm sm:p-6">
    ...
    @can('comment', $task)
        <div class="mt-5 space-y-2">
            ...
            <textarea id="task-comment-body" wire:model.blur="body" rows="3" class="block w-full rounded-2xl border border-slate-400 px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900" placeholder="{{ __('Markdown supported.') }}"></textarea>
