                                            ...
                                            <div class="flex items-center justify-between gap-2 pt-2 border-t border-slate-200">
                                                ...
                                                <form wire:submit.prevent="confirmImport" class="space-y-3">
                                                    ...
                                                    <button type="submit"
                                                            ...
                                                            class="inline-flex items-center justify-center gap-1 rounded-full bg-emerald-500 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-600 disabled:opacity-75 disabled:cursor-wait">
                                                        <svg wire:loading.remove wire:target="confirmImport" class="h-3.5 w-3.5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
                                                        <svg wire:loading wire:target="confirmImport" class="h-3.5 w-3.5 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
