        ...
        <section class="rounded-3xl border border-slate-100 bg-white/80 p-6 shadow-sm">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="mini_addon_amount" wire:model="form.mini_addon_amount" placeholder="e.g. 100.00" class="mt-2 block w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200">
