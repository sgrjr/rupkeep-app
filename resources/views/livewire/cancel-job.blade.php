                    ...
                    <form wire:submit="cancel" class="px-6 py-4">
                        <div class="space-y-4">
                            <div>
                                ...
                                <select wire:model="cancellationType" class="mt-2 w-full rounded-xl border border-slate-400 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900">
                            ...
                            <div>
                                ...
                                <select wire:model="cancellationReason" class="mt-2 w-full rounded-xl border border-slate-400 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900">
                            ...
                            <div>
                                ...
                                <textarea wire:model="customReason" rows="3" placeholder="{{ __('Add any additional details about the cancellation...') }}" class="mt-2 w-full rounded-xl border border-slate-400 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900"></textarea>
                                @error('customReason')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
