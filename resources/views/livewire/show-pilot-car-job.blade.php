                                ...
                                <div class="mt-3 flex flex-wrap items-center gap-2">
                                    ...
                                    @can('delete', $invoice)
                                        <button type="button"
                                                ...
                                                wire:confirm="{{ __('Are you sure you want to delete this invoice? This action cannot be undone.') }}"
                                                class="inline-flex items-center gap-1 rounded-full border border-red-200 bg-red-50/70 px-3 py-1 text-[11px] font-semibold text-red-600 transition hover:bg-red-500 hover:text-white"
