        ...
        <div class="rounded-3xl border border-slate-200 bg-white/90 p-4 shadow-sm">
            <form method="GET" action="{{ route('user-events.index') }}" class="flex flex-wrap items-center gap-4">
                <div>
                    ...
                    <select name="severity" class="mt-2 block rounded-xl border border-slate-400 px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900">
                ...
                <div>
                    ...
                    <select name="type" class="mt-2 block rounded-xl border border-slate-400 px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900">
                        <option value="">{{ __('All') }}</option>
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <form method="POST" action="{{ route('user-events.prune') }}" class="flex items-end gap-3" onsubmit="return confirm('{{ __('Are you sure you want to delete old user events? This action cannot be undone.') }}');">
                    ...
                    <div>
                        ...
                        <select name="keep_days" class="block rounded-xl border border-slate-400 px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900" required>
