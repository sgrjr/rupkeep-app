                    ...
                    <section class="rounded-3xl border border-slate-100 bg-white/90 p-6 shadow-sm">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <x-input-error for="last_oil_change_at" class="mt-2 text-xs font-semibold text-red-500" />
                            </div>
                            <div>
                                <label for="next_oil_change_due_at" class="block text-xs font-semibold uppercase tracking-wide text-slate-600">{{ __('Next Oil Change Due') }}</label>
                                <input id="next_oil_change_due_at" name="next_oil_change_due_at" type="date" value="{{ old('next_oil_change_due_at', optional($vehicle->next_oil_change_due_at)->toDateString()) }}" class="mt-2 block w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200">
                                <x-input-error for="next_oil_change_due_at" class="mt-2 text-xs font-semibold text-red-500" />
                            </div>
                            <div>
                                <label for="last_inspection_at" class="block text-xs font-semibold uppercase tracking-wide text-slate-600">{{ __('Last Inspection') }}</label>
                                <input id="last_inspection_at" name="last_inspection_at" type="date" value="{{ old('last_inspection_at', optional($vehicle->last_inspection_at)->toDateString()) }}" class="mt-2 block w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200">
                                <x-input-error for="last_inspection_at" class="mt-2 text-xs font-semibold text-red-500" />
                            </div>
                            <div>
                                <label for="next_inspection_due_at" class="block text-xs font-semibold uppercase tracking-wide text-slate-600">{{ __('Next Inspection Due') }}</label>
