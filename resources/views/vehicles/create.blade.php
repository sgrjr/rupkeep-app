            ...
            <section class="rounded-3xl border border-slate-100 bg-white/90 p-6 shadow-sm">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input id="name" name="name" value="{{ old('name') }}" required placeholder="{{ __('E.g. Chevy Tahoe #2') }}" class="mt-2 block w-full rounded-xl border border-slate-400 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900">
                    ...
                    <div>
                        ...
                        <input id="odometer" name="odometer" type="number" min="0" value="{{ old('odometer') }}" placeholder="0" class="mt-2 block w-full rounded-xl border border-slate-400 bg-white px-3 py-2 text-sm shadow-sm focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200 text-slate-900">
